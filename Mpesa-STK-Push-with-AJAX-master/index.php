        ...
        <div class="row d-flex justify-content-center">
            <div class="col-sm-12">
                <div class="card mx-auto">
                    <p class="heading" style="text-align:center; ">Proceed with checkout.<br> Enter your phone number below and wait for an STK push.</p>
                    <form class="card-details " method="POST" action="./mpesa.php" id="form">
                        <div class="form-group mb-0">
                            <div class="feedback" id="feedback"></div>
                            <p class="text-warning mb-0">Phone Number</p>
                            <input type="text" name="phone-num" placeholder="254712345678" size="17" id="cno" minlength="10" maxlength="12" id="phone">
                            <img src="./assets/mpesa.png" width="64px" height="60px" />
                        </div>

                        <div class="form-group">
                            <p class="text-warning mb-0">Amount</p> <input type="text" name="amount" placeholder="" size="17" id="amount" readonly value="4500">
                        </div>
